...
extern const int uBuildIcon = 17;    // 建筑单位图标ID
...
extern const int uIconID = 25;    //非建筑单位图标ID
...
extern const int uPopulation = 110;    //修改单位的人口空间系数。人口空间系数会直接影响玩家的人口余量(资源ID 4)以及人口占用(资源ID 11)。当单位的人口空间系数为0时,其人口占用和人口余量尽数为0 取值情况 {-1："绝大部分单位（默认）", -0.9:"村民、僧侣类单位（需研究大乘佛教）", 0:"单位不占用人口"}
